...
public class colocarpeças {
    static int [] inicio (int vez) throws InterruptedException, IOException {
        ...
        mapa.imprimirMapa(jogador1,jogador2);
        jogador1 = pecas.colocarNavioDe3canos(jogador1,vez,6);
        mapa.imprimirMapa(jogador1, jogador2);
        jogador1 = pecas.colocarNavioDe3canos(jogador1,vez,5);
        mapa.imprimirMapa(jogador1, jogador2);
        jogador1 = pecas.colocarNavioDe2canos(jogador1,vez,4);
        mapa.imprimirMapa(jogador1, jogador2);
        jogador1 = pecas.colocarNavioDe2canos(jogador1,vez,3);
        mapa.imprimirMapa(jogador1, jogador2);
        jogador1 = pecas.colocarNavioDe2canos(jogador1,vez,2);
        mapa.imprimirMapa(jogador1, jogador2);

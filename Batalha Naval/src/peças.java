...
public class peças {
    ...
    int posiçao(String input) {
        ...
        else if(S[0] == "A" || S[0] == "a"){return Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "B" || S[0] == "b"){return 10 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "C" || S[0] == "c"){return 20 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "D" || S[0] == "d"){return 30 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "E" || S[0] == "e"){return 40 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "F" || S[0] == "f"){return 50 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "G" || S[0] == "g"){return 60 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "H" || S[0] == "h"){return 70 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "I" || S[0] == "i"){return 80 + Integer.parseInt(S[1]) - 1;}
        else if(S[0] == "J" || S[0] == "j"){return 90 + Integer.parseInt(S[1]) - 1;}
    ...
    static void colocarPortaAvioes() {
    ...
    static void colocarNavioDe4canos() {
    ...
    static void colocarNavioDe3canos() {
    ...
    static void colocarNavioDe2canos() {
    ...
    static void colocarNavioDe1cano() {
    ...
    public static void main (String[] args) {
        colocarPortaAvioes();
        colocarNavioDe4canos();
        colocarNavioDe3canos();
        colocarNavioDe2canos();
        colocarNavioDe1cano();
    }
}
